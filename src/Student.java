...
public class Student {
	...
	/**
	 * Takes in a date and time spent attending on that date
	 * and either adds an attendance entry (mapping the 
	 * date to the time spent) or updates an entry that 
	 * is already present with the same date by adding
	 * to the time.
